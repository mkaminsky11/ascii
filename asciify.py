...
def closest(r,g,b):
	for key in xterm_colors:
		value = xterm_colors[key]
		if is_similar((r,g,b), value, THRESHOLD):
			return key
	return "0"
...
for key in xterm_colors:
	hex_colors[key] = xterm_colors[key]
	h = xterm_colors[key].lstrip("#")
	xterm_colors[key] = tuple(int(h[i:i+2], 16) for i in (0, 2 ,4))